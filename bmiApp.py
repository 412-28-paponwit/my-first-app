...
#ส่วนที่ 1 หัวขอหน้าเว็บ (Title สีแดง)
...
weight = st.numbre_input("กรอกน้ำหนักของคุณ (กิโลกรัม):",min_value=1.0, value=1.0)
height_cm = st.numbre_input("กรอกน้ส่วนสูงของคุณ (เซนติเมตร):",min_value=1.0, value=1.0,)
...
st.divider()
st.write("นายปพนวิช พงษ์มา เลขที่28 ม.4/12")
